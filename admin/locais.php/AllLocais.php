            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $InfoLocais_Turisticos = lerLocais();

                        foreach ($InfoLocais_Turisticos as $Infolocais) {
                        ?>
                            <tr>
                                <th><?php echo $Infolocais['id']; ?></th>
                                <td><?php echo $Infolocais['img']; ?></td>
                                <td><?php echo $Infolocais['titulo']; ?></td>
                                <td><?php echo $Infolocais['texto']; ?></td>
                                <td><?php echo $Infolocais['links']; ?></td>
                                <td>
                                    <a href="../../src/controlador/admin/controlador-locais.php?<?= 'info=atualizar&id=' . $Infolocais['id'] ?>">
                                        <button type="button" class="btn btn-info">Editar</button>
                                    </a>

                                    <a href="../../src/controlador/admin/controlador-locais.php?<?= 'info=deletar&id=' . $Infolocais['id'] ?>"><button class="btn btn-danger" type="submit">Excluir</button></a>
                                </td>
                            </tr>
                        <?php
                        }
